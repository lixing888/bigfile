...
/**
 * @program: bigfile
 * @description: 下载指定文件夹下的所有文件
 * @author: lixing
 * @create: 2020-11-17 19:51
 **/
...
//    @GetMapping("/download")
    public static void downloadLocal(String filePath, HttpServletResponse response) throws IOException, IOException {
